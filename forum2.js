...
// De alexiane21 - Objet de la conversation : HTML
// Demande :
// Bonjour, est-ce que quelqu'un peut m'aider pour le Local Storage s'il vous plait ? 

 
//  Répondre

// De Romane26 - Objet de la conversation : Pharo
// Demande :
// Comment on fait une classe en pharo ? 
// Pour faire une classe en pharo, il faut que tu ailles dans l'application, que tu ouvres le system browser et que dans la partie "Object subclass: #NameOfSubclass" tu remplaces le NameOfSubclass par le nom de ta classe et tu enregistres.

// De younessL - Objet de la conversation : Bases de données
// Demande :
